            ...
            if ($user1->getNumRows() > 0) {
                foreach ($user1->getResult() as $user) {
                    ...
                    if (password_verify($this->request->getVar("password"), $password)) {
                        ...
                        $this->session->set("identity_fb", $identity->identity_fb);
                        $this->session->set("identity_twitter", $identity->identity_twitter);
                        $this->session->set("identity_ig", $identity->identity_ig);
